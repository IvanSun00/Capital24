...
<body>
  ...
  <div class="container mt-5 py-4 position-relative">
    ...
    <h1 class="text-center" style="font-weight: bold;">BAYAR HUTANG BANK</h1>
    ...
    <div class="px-4 pt-2 pb-4 mt-4" style="background-color: white; border-radius: 30px; box-shadow: 10px 10px 20px rgba(0,0,0,0.2);">
      ...
      <form action="" id="form_pembayaran">
        <div class="mb-3">
        ...
        <div class="mb-3">
          <label for="nominal" class="form-label">Jumlah Bayar:</label>
          <input type="number" class="form-control" id="nominal" placeholder="Bayar" min="0">
        </div>
